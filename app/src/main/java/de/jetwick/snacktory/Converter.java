    ...
    public String streamToString(InputStream is, int maxBytes, String enc) {
        ...
        try {
            ...
            try {
                ...
                Timber.w("Using default encoding:" + UTF8
            ...
            while (true) {
                if (bytesRead >= maxBytes) {
                    Timber.w("Maxbyte of " + maxBytes + " exceeded! Maybe html is now broken but try it nevertheless. Url: " + url);
                    break;
                }
        ...
        if (encIndex > 0) {
            ...
            if (lastEncIndex > encIndex + clength && lastEncIndex < encIndex + clength + 40) {
                ...
                try {
                    ...
                    Timber.w("Couldn't reset stream to re-read with new encoding " + tmpEnc + " "
                            + ex.toString());
                }
            }
        }
