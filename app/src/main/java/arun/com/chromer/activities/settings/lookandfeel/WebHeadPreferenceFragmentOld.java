...
public class WebHeadPreferenceFragmentOld extends BasePreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public WebHeadPreferenceFragmentOld() {
        // Required empty public constructor
    }

    public static WebHeadPreferenceFragmentOld newInstance() {
        final WebHeadPreferenceFragmentOld fragment = new WebHeadPreferenceFragmentOld();
